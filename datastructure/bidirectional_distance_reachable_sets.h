...
namespace whfc {
	class BidirectionalDistanceRange {
	public:
	...
	class BidirectionalDistanceReachableNodes : public ReachableNodesBase {
	public:
		friend class DistanceReachableHyperedges;
		
		using Base = ReachableNodesBase;
		using DistanceT = BidirectionalDistanceRange::DistanceT;
		...
		void fullReset() {
			...
			s = BidirectionalDistanceRange(sourceSettledDistance);
			t = BidirectionalDistanceRange(targetSettledDistance);
			Base::fullReset();
		}
	...
	class BidirectionalDistanceReachableHyperedges {
	public:
		using DistanceT = BidirectionalDistanceRange::DistanceT;
		
		BidirectionalDistanceReachableHyperedges(const FlowHypergraph& hg) : inDistance(hg.numHyperedges(), unreachableDistance), outDistance(hg.numHyperedges(), unreachableDistance),
		...
		void compareDistances(BidirectionalDistanceReachableNodes& n) {
			unused(n);
